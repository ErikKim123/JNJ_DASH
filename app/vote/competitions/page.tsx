...
import { setCompetition } from '@/hooks/vote/useCompetition';
import type { Competition } from '@/lib/vote/sheet-schema';
...
function CompetitionRow({
  ...
  const judgeUrl =
    typeof window !== 'undefined'
      ? `${window.location.origin}/vote/enter?c=${encodeURIComponent(item.id)}`
      : `/vote/enter?c=${encodeURIComponent(item.id)}`;
  return (
    <div
      style={{
        position: 'relative',
