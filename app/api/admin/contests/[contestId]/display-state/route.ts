// PUT /api/admin/contests/[contestId]/display-state   { round?, step?, follow? }
//   MC 모바일이 표출 포인터(현재 라운드/스텝)와 "MC 따라가기" 원격 스위치를 기록.
//   미들웨어(admin 세션)로 보호됨.
...
const BodySchema = z
  ...
  .refine((b) => b.round !== undefined || b.follow !== undefined, {
    message: '변경할 값이 없습니다',
  });
