// MC 모바일 콘솔 셸 — 하단 탭(화면전환 / 예선 / 본선 / 결승) + 상단 대회 헤더.
'use client';
...
export function MCConsole({
  ...
  return (
    <div className="min-h-screen bg-bg text-ink">
      {/* 상단 헤더 */}
      <header className="sticky top-0 z-20 bg-bg/95 backdrop-blur border-b border-border px-4 py-3 flex items-center justify-between gap-3">
