...
export function closeSvg(): string {
  ...
  return shell(`
    ...
    <text x="640" y="520" text-anchor="middle" font-family="'Cinzel', 'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-weight="bold" font-size="50" letter-spacing="6" fill="url(#goldg)">{{close_title}}</text>
    <text x="640" y="560" text-anchor="middle" font-family="'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-size="20" letter-spacing="8" fill="#E8E6DA" opacity="0.85">{{close_subtitle}}</text>
    <text x="640" y="590" text-anchor="middle" font-family="'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-style="italic" font-size="14" letter-spacing="4" fill="#D4AF37">{{close_message}}</text>
