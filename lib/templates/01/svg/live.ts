...
export function liveSvg(): string {
  return shell(`
    ...
    <text x="200" y="103" font-family="'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-style="italic" font-size="13" letter-spacing="4" fill="#9A98A8">{{stage_label}}</text>

    <text x="1200" y="103" text-anchor="end" font-family="'Cinzel', 'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-weight="bold" font-size="20" letter-spacing="6" fill="#FFD56B">{{round_title}}</text>
