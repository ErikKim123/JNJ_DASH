  ...
  return `
    <defs>
      <radialGradient id="${id}" gradientUnits="userSpaceOnUse" cx="${f(cx)}" cy="${f(cy)}" r="${len}">
        <stop offset="0" stop-color="#DDE5FF" stop-opacity="0.14"/>
        <stop offset="0.55" stop-color="#DDE5FF" stop-opacity="0.03"/>
