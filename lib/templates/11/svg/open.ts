...
function beams(): string {
  return `
    <defs>
      <linearGradient id="t11OpenBeam" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0" stop-color="#FFB23F" stop-opacity="0.08"/>
        <stop offset="1" stop-color="#BFF6FF" stop-opacity="0"/>
      </linearGradient>
    </defs>
    <g fill="url(#t11OpenBeam)">
...
export function openSvg(): string {
  ...
  return shell(`
    ...
    <defs><clipPath id="t11OpenClip"><text ${titleAttrs}>OPEN</text></clipPath></defs>
    <g clip-path="url(#t11OpenClip)">
      <rect x="-300" y="320" width="150" height="170" fill="url(#t11Shine)" opacity="0.7" transform="skewX(-18)">
