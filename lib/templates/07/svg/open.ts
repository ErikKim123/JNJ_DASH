...
function beams(): string {
  return `
    <defs>
      <linearGradient id="t07Beam" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0" stop-color="#FFE3EE" stop-opacity="0.22"/>
        <stop offset="1" stop-color="#FFE3EE" stop-opacity="0"/>
      </linearGradient>
    </defs>
    <g fill="url(#t07Beam)">
...
export function openSvg(): string {
  ...
  return shell(`
    ...
    <defs><clipPath id="t07OpenClip"><text ${titleAttrs}>OPEN</text></clipPath></defs>
    <g clip-path="url(#t07OpenClip)">
      <rect x="-300" y="320" width="150" height="170" fill="url(#t07Shine)" opacity="0.7" transform="skewX(-18)">
