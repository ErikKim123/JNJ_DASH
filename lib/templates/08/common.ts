  ...
  return `
    <defs>
      <radialGradient id="${id}" gradientUnits="userSpaceOnUse" cx="${f(cx)}" cy="${f(cy)}" r="${len}">
        <stop offset="0" stop-color="#BFF6FF" stop-opacity="0.16"/>
        <stop offset="0.55" stop-color="#BFF6FF" stop-opacity="0.035"/>
