...
function beams(): string {
  return `
    <defs>
      <linearGradient id="t08Beam" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0" stop-color="#7FEFFF" stop-opacity="0.1"/>
...
export function openSvg(): string {
  ...
  return shell(`
    ...
    <defs><clipPath id="t08OpenClip"><text ${titleAttrs}>OPEN</text></clipPath></defs>
    <g clip-path="url(#t08OpenClip)">
      <rect x="-300" y="320" width="150" height="170" fill="url(#t08Shine)" opacity="0.7" transform="skewX(-18)">
