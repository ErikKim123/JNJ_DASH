...
function beams(): string {
  return `
    <defs>
      <linearGradient id="t09Beam" x1="0" y1="0" x2="0" y2="1">
...
export function openSvg(): string {
  ...
  return shell(`
    ...
    <defs><clipPath id="t09OpenClip"><text ${titleAttrs}>OPEN</text></clipPath></defs>
    <g clip-path="url(#t09OpenClip)">
      <rect x="-300" y="320" width="150" height="170" fill="url(#t09Shine)" opacity="0.7" transform="skewX(-18)">
