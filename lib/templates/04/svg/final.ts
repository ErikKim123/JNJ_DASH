...
export function finalPrepSvg(): string {
  ...
  return shell(`
    ...
    <text x="640" y="288" text-anchor="middle" font-family="'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-style="italic" font-size="20" letter-spacing="10" fill="#F5C64E">{{stage_label}}</text>
    ...
    <text x="640" y="510" text-anchor="middle" font-family="'Cinzel', 'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-weight="bold" font-size="76" letter-spacing="12" fill="url(#goldgt)">{{round_title}}</text>
    <text x="640" y="552" text-anchor="middle" font-family="'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-size="20" letter-spacing="14" fill="#F7F4EA" opacity="0.85">{{round_subtitle}}</text>
    ...
    <g transform="translate(640 594)">
      ...
      <text text-anchor="middle" y="6" font-family="'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-size="15" letter-spacing="6" fill="#DDAE42">{{participants}}</text>
    </g>
...
export function finalWrapupSvg(): string {
  ...
  return shell(`
    ${topHeader()}
    <text x="640" y="160" text-anchor="middle" font-family="'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-style="italic" font-size="22" letter-spacing="10" fill="#F5C64E">{{stage_label}}</text>

    <text x="640" y="270" text-anchor="middle" font-family="'Cinzel', 'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-weight="bold" font-size="62" letter-spacing="6" fill="url(#goldgt)">{{wrap_title}}</text>
    <text x="640" y="316" text-anchor="middle" font-family="'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-size="24" letter-spacing="14" fill="#F7F4EA" opacity="0.9">{{wrap_subtitle}}</text>
    ...
    <text x="640" y="606" text-anchor="middle" font-family="'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-style="italic" font-size="15" letter-spacing="4" fill="#D6D1C4">{{wrap_message}}</text>
...
export function finalResultSvg(): string {
  const champCol = (xCenter: number, side: 'L' | 'F'): string => {
    ...
    return `
      <g transform="translate(${xCenter} 0)">
        <text x="0" y="378" text-anchor="middle" font-family="ui-monospace, monospace" font-size="22" font-weight="600" letter-spacing="8" fill="#DDAE42">${sideLabel}</text>
        ...
        <g class="jnj-reveal" data-reveal-id="${side}-2">
          ...
          <text x="-105" y="600" text-anchor="middle" font-family="ui-monospace, monospace" font-size="10" letter-spacing="5" fill="#DCDCE4">2ND</text>
        </g>
        ...
        <g class="jnj-reveal" data-reveal-id="${side}-1">
          ...
          <text x="0" y="624" text-anchor="middle" font-family="ui-monospace, monospace" font-size="11" letter-spacing="6" fill="#F5C64E">1ST</text>
        </g>

        <g class="jnj-reveal" data-reveal-id="${side}-3">
          ${hexagonFrame(105, 502, `{{${prefix}_3}}`, 36, dly + 0.65, 16, `{{${prefix}_num_3}}`, `{{${prefix}_photo_3}}`)}
          <text x="105" y="600" text-anchor="middle" font-family="ui-monospace, monospace" font-size="10" letter-spacing="5" fill="#D08F63">3RD</text>
        </g>
      </g>
    `;
  };
  ...
  return shell(`
    ...
    <text x="640" y="296" text-anchor="middle" font-family="'Cinzel', 'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-weight="bold" font-size="54" letter-spacing="12" fill="url(#goldgt)">{{result_title}}</text>
    <text x="640" y="328" text-anchor="middle" font-family="'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-style="italic" font-size="15" letter-spacing="6" fill="#F7F4EA" opacity="0.9">{{result_subtitle}}</text>
...
export function finalPairingSvg(): string {
  return shell(`
    ...
    <text x="640" y="216" text-anchor="middle" font-family="'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-style="italic" font-size="22" letter-spacing="10" fill="#F5C64E">{{stage_label}}</text>
    ...
    <g>
      ...
      <text x="640" y="438" text-anchor="middle" font-family="'Cinzel', 'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-weight="bold" font-size="118" letter-spacing="24" fill="url(#goldgt)">{{round_title}}</text>
    </g>
    ...
    <text x="640" y="552" text-anchor="middle" font-family="'Cormorant Garamond', Georgia, serif" font-style="italic" font-size="16" letter-spacing="5" fill="#DDAE42" opacity="0.9">
