...
export function liveSvg(): string {
  return shell(`
    ...
    <text x="200" y="103" font-family="'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-style="italic" font-size="13" letter-spacing="4" fill="#D6D1C4">{{stage_label}}</text>

    <text x="1200" y="103" text-anchor="end" font-family="'Cinzel', 'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-weight="bold" font-size="20" letter-spacing="6" fill="#F5C64E">{{round_title}}</text>
    ...
    <g transform="translate(640 200)">
      ...
      <text y="6" text-anchor="middle" font-family="ui-monospace, monospace" font-size="14" letter-spacing="8" fill="#DDAE42">— ON STAGE —</text>
    </g>
    ...
    <g transform="translate(640 410)">
      ...
      <text y="22" text-anchor="middle" font-family="'Cinzel', 'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-weight="bold" font-size="68" letter-spacing="12" fill="url(#goldgt)">LIVE</text>
    </g>

    <text x="640" y="592" text-anchor="middle" font-family="'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-style="italic" font-size="22" letter-spacing="4" fill="#FFDF94">{{live_message}}</text>
