...
export function wrapupSvg(): string {
  return shell(`
    ...
    <text x="640" y="280" text-anchor="middle" font-family="'Cinzel', 'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-weight="bold" font-size="68" letter-spacing="6" fill="url(#goldgt)">{{wrap_title}}</text>
    <text x="640" y="328" text-anchor="middle" font-family="'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-size="26" letter-spacing="14" fill="#F7F4EA" opacity="0.85">{{wrap_subtitle}}</text>
    ...
    <text x="640" y="582" text-anchor="middle" font-family="'Cormorant Garamond', Georgia, 'Gulim', '굴림', serif" font-style="italic" font-size="14" letter-spacing="4" fill="#D6D1C4">{{wrap_message}}</text>
