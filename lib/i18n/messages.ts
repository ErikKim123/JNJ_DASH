...
export const MESSAGES_EN = {
  ...
  'cf.pairingGroupHint': 'Couples per group. When set above 0, the pairing list is split into groups A, B, C… of this size. 0 = no grouping (single list).',
...
export const MESSAGES_KO: Record<MessageKey, string> = {
  ...
  'cf.pairingGroupHint': '그룹(조)당 커플 수. 0보다 크면 페어링 목록을 이 수만큼씩 끊어 A·B·C… 조로 나눠 보여줍니다. 0 = 그룹 미사용(한 목록).',
