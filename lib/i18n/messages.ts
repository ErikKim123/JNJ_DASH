...
export const MESSAGES_EN = {
  ...
  'matrix.tieModalHelp': 'These candidates are tied at the cutoff with more entrants than open slots. Check who advances; the rest are eliminated. Saving commits the qualifiers — checked entrants go to the next round.',
...
export const MESSAGES_KO: Record<MessageKey, string> = {
  ...
  'matrix.tieModalHelp': '정원 경계에서 같은 표로 묶여 자리보다 인원이 많은 후보들입니다. 올릴 사람을 체크하세요. 나머지는 탈락합니다. 저장하면 통과자가 확정되고 체크된 사람은 다음 라운드(본선)로 갑니다.',
  'matrix.tieScore': '동점',
