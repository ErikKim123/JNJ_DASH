...
export const MESSAGES_EN = {
  ...
  'matrix.judgeUnsubmit': 'Undo submit',
  'matrix.judgeUnsubmitTitle': 'Cancel this judge\'s SUBMIT (e.g. submitted by mistake). Scores are kept; the judge can edit and submit again.',
  'matrix.confirmUnsubmitJudge': 'Cancel SUBMIT for judge "{NAME}"? Their scores are kept, but the column turns back to not-submitted and they can edit and resubmit.',
  ...
  'cf.endDate': 'End Date',
  'cf.templateTitle': 'Design Template',
  'cf.templateSelectLabel': 'Template',
  'cf.templatePreviewScreen': 'Preview screen',
  'cf.templateSelect': 'Select',
  'cf.templateSelected': 'Selected',
  'cf.templateNotRegisteredOption': 'not registered',
  'cf.templateHint': 'Pick the display design. Previews use sample data — switch screens to compare.',
  'cf.templateUnregistered':
    'Template {N} is not registered — the display falls back to template 01. Pick one below.',
  'cf.templateZoom': 'Enlarge',
  'cf.templateClose': 'Close',
  'cf.templateUse': 'Use this template',
  'cf.templateInUse': 'Currently selected',
  'cf.tplScreenPrep': 'PREP',
  'cf.tplScreenOpen': 'OPEN',
  'cf.tplScreenLive': 'LIVE',
  'cf.tplScreenResult': 'RESULT',
  'cf.tplScreenCeremony': 'CEREMONY',
  'cf.group': 'Group',
  ...
  'cf.onlineScoring.crowd_connection': 'Crowd Connection',
  'cf.onlineScoring.team_chemistry': 'Team Chemistry',
  'cf.onlineScoring.musical_energy': 'Musical Energy',
  // Actions
  'cf.create': 'Create',
  'cf.save': 'Save',
  'cf.saving': 'Saving…',
...
export const MESSAGES_KO: Record<MessageKey, string> = {
  ...
  'matrix.judgeUnsubmit': '제출 취소',
  'matrix.judgeUnsubmitTitle': '이 심사위원의 SUBMIT 을 취소합니다(실수 제출 등). 입력된 점수는 유지되며, 심사위원이 다시 수정·제출할 수 있습니다.',
  'matrix.confirmUnsubmitJudge': '심사위원 "{NAME}"의 제출을 취소할까요? 점수는 그대로 유지되지만 컬럼이 미제출 상태로 돌아가며, 다시 수정·제출할 수 있습니다.',
  ...
  'cf.startDate': '시작일',
  'cf.endDate': '종료일',
  'cf.templateTitle': '디자인 템플릿',
  'cf.templateSelectLabel': '템플릿 선택',
  'cf.templatePreviewScreen': '미리보기 화면',
  'cf.templateSelect': '선택',
  'cf.templateSelected': '선택됨',
  'cf.templateNotRegisteredOption': '미등록',
  'cf.templateHint': '표출 화면 디자인을 고릅니다. 미리보기는 샘플 데이터이며, 화면 탭을 바꿔 비교할 수 있습니다.',
  'cf.templateUnregistered':
    '{N}번 템플릿은 등록되지 않았습니다 — 표출은 01번으로 대체됩니다. 아래에서 선택하세요.',
  'cf.templateZoom': '크게 보기',
  'cf.templateClose': '닫기',
  'cf.templateUse': '이 템플릿 사용',
  'cf.templateInUse': '현재 선택됨',
  'cf.tplScreenPrep': '대기',
  'cf.tplScreenOpen': '오픈',
  'cf.tplScreenLive': '심사',
  'cf.tplScreenResult': '통과자',
  'cf.tplScreenCeremony': '시상식',
  'cf.group': '그룹',
  ...
  'cf.onlineScoring.crowd_connection': '관객 교감',
  'cf.onlineScoring.team_chemistry': '팀 케미',
  'cf.onlineScoring.musical_energy': '음악적 에너지',
  // Actions
  'cf.create': '생성',
  'cf.save': '저장',
  'cf.saving': '저장 중…',
